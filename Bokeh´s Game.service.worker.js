...
/** @type {string} */
const CACHE_VERSION = '1744763415|17933359857';
/** @type {string} */
const CACHE_PREFIX = 'Bokeh´s Game-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Bokeh´s Game.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Bokeh´s Game.html","Bokeh´s Game.js","Bokeh´s Game.offline.html","Bokeh´s Game.icon.png","Bokeh´s Game.apple-touch-icon.png","Bokeh´s Game.audio.worklet.js","Bokeh´s Game.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Bokeh´s Game.wasm","Bokeh´s Game.pck","Bokeh´s Game.side.wasm"];
